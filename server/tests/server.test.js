...
describe('DELETE /todos/:id', ()=>{
    ...
    it('should not remove a todo requested by diff user', (done)=> {
        var hexId = todos[1]._id.toHexString();
...
describe('PATCH /todos/:id', () => {
    ...
    it('should clear completed at when todo is not completed',(done)=>{
     ...
     it('should NOT update todo by diff user', (done)=>{
        //grap id for first item
        var hexId = todos[0]._id.toHexString();
        text = 'Something else to do';
        //update text, set completed true 
...
describe ('GET /users/me', () => {
    ...
    it ('should return 401 if not authinticated', (done) => {
         request(app)
            .get('/users/me')
            //.set('x-auth',users[1].tokens[0].token)
            .expect(401)
...
describe('POST /users', ()=>{
    it ('should create a user', (done) => {
        var email = 'example@examplea.com';
        var password = '123mnbhhh';
    ...
    it ('should return a validation errors if request invalid', (done) => {
        var email = 'example123';
        var password = '123234234fa';
